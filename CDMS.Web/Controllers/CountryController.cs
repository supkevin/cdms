    ...
    public class CountryController : BaseController
    {
        ...
        public ActionResult _List(string txt, string orderby, string sort, int page = 1)
        {
            ...
            if (!string.IsNullOrEmpty(txt))
                Sql += " && (CX_Country.Contains(@0) || CX_Country_Remarks.Contains(@0))";

            var query = this._countryService.GetAll().Where(Sql, obj.ToArray());
        ...
        public ActionResult Create(Country model)
        {
            ...
            try
            {
                ...
                #region Service資料庫
                this._countryService.Create(model);
                #endregion
        ...
        public ActionResult DeleteConfirmed(Country model)
        {
            ...
            {
                #region Service資料庫
                this._countryService.Delete(model);
                #endregion
