...
{
    public class InvoicingInventoryStatisticsController : BaseController
    {
        private readonly IStockTrackService _StockTrackService;
        private readonly IGlobalService _GlobalService;

        public InvoicingInventoryStatisticsController(
        ...
        private void InitViewBag(StockTrackViewModel info)
        {
            ...
            sort.Add(new MyTextValue { Text = "廠牌", Value = "TotalQty", Disabled = false });
            sort.Add(new MyTextValue { Text = "產品類別", Value = "TotalAmount", Disabled = false });            

            //ViewBag.SortOrderList = new SelectList(sort, "Value", "Text", null);
            ViewBag.ClassificationList = new SelectList(sort, "Value", "Text", null);
